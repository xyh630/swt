<template>
  <div class="dv-decoration-10" :ref="ref">
    <svg :width="width" :height="height">
      <polyline
        stroke="rgba(40,192,180, 0.3)"
        stroke-width="2"
        :points="`0, ${height / 2} ${width}, ${height / 2}`"
      />

      <polyline
        stroke="rgba(40,192,180, 1)"
        stroke-width="2"
      ...
      <circle cx="2" :cy="height / 2" r="2" fill="#28C0B4">
        <animate
          :id="animationId1"
          attributeName="fill"
          values="#28C0B4;#00c2ff"
      ...
      <circle :cx="width * 0.2" :cy="height / 2" r="2" fill="#28C0B4">
        <animate
          :id="animationId3"
          attributeName="fill"
          values="#28C0B4;#00c2ff"
      ...
      <circle :cx="width * 0.8" :cy="height / 2" r="2" fill="#28C0B4">
        <animate
          :id="animationId5"
          attributeName="fill"
          values="#28C0B4;#00c2ff"
      ...
      <circle :cx="width - 2" :cy="height / 2" r="2" fill="#28C0B4">
        <animate
          :id="animationId7"
          attributeName="fill"
          values="#28C0B4;#00c2ff"
...
<script>
import autoResize from '../utils/mixin/autoResize'
