<template>
  ...
  <div class="pageComponent" v-if="pageConfig.total">
      <!--上一页-->
      <button @click="prePage" :disabled="currentPage === 1" style="border:0;background:none;color:#2CC98B;font-size:.32rem">上一页</button>
      <!--总页数小于8的-->
      ...
      <template v-else-if="currentPage < 4">
        ...
        <button :disabled="true" style="color:#2CC98B">···</button>
      ...
      <!--下一页-->
      <button @click="nextPage" :disabled="currentPage === pageTotal" style="border:0;background:none;color:#2CC98B;font-size:.32rem">下一页</button>
    </div>
</template>
